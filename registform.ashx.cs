    ...
    public class registform : IHttpHandler, IRequiresSessionState
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            try
            {
                ...
                //此三格可能有人填寫特殊字元
                string introduction =context.Request.Unvalidated.Form["introduction"];
                string why = context.Request.Unvalidated.Form["why"];
                string essay = context.Request.Unvalidated.Form["essay"];
            ...
            {
                context.Response.Write("OH~NO~看來有地方出錯囉");
            }
